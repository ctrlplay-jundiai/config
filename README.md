...
```powershell
choco install adobereader blender ccleaner git googlechrome googledrive jetbrainsmono vscode winrar arduino blender godot nodejs python3 unity-hub xampp-81 -y
```
